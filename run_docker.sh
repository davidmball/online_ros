...
cont=$(docker run -d -p 9090:9090 -v "$ws_dir":/home/root/catkin_ws/src -w /home/root/catkin_ws/ --name "$name" "$image" /bin/sh -c "roslaunch rosbridge_server rosbridge_websocket.launch & rosrun tf2_web_republisher tf2_web_republisher & catkin_make && stdbuf -o L $run_cmd")
